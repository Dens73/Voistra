...
import type { AuthUser, DirectConversation, Friend, FriendRequest } from '../types';

type FriendsSidebarStrings = {
  accept: string;
  addFriend: string;
  copyId: string;
      ...
      <div className="rounded-[22px] border border-white/6 bg-white/[0.03] p-4">
        ...
        <div className="grid max-h-[48vh] gap-2.5 overflow-y-auto pr-1">
          ...
          {sortedFriends.map((friend) => {
            ...
            const isActive = activeParticipantId === friend.id;
